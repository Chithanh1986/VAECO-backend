...
const publishPaths = ["/login", "/account", "/show_pointCode", "/search_PC", "/load_plan", "/show_all_PC", "/load_team", "/loadEA", "/getPowerData", "/search_user"];
const leaderPaths = ["/load_team", "/search_user", "/update", "/flight_plan", "/save_plan", "/saveEA"];
